...
wet.builder.refFooter = function (a, h) {
    a = a || {};
    return "\t\t\x3c!--[if gte IE 9 | !IE ]>\x3c!--\x3e<script src='" + ("external" == a.jqueryEnv ? "https://ajax.googleapis.com/ajax/libs/" : "../wet-boew/js/") + 'jquery/2.1.4/jquery.min.js\' integrity="sha256-ImQvICV38LovIsvla2zykaCTdEh1Z801Y+DSop91wMU= sha384-8gBf6Y4YYq7Jx97PIqmTwLPin4hxIzQw5aDmUg/DDhul9fFpbbLcLh3nTIIDJKhx sha512-AFwxAkWdvxRd9qhYYp1qbeRZj6/iTNmJ2GFwcxsMOzwwTaRwz2a/2TX225Ebcj3whXte1WGQb38cXE5j7ZQw3g==" crossorigin="anonymous">\x3c/script><script src=\'' +
...
wet.builder.splashTop = function (a, h) {
    a = a || {};
    return "\t\t\x3c!--[if gte IE 9 | !IE ]>\x3c!--\x3e<link href='" + '../wet-boew/assets/favicon.ico\' rel="icon" type="image/x-icon"><link rel="stylesheet" href=\'' + "../wet-boew/css/theme.min.css'>\x3c!--<![endif]--\x3e<link rel=\"stylesheet\" href='" + wet.builder.environment(a) + "css/messages.min.css'>\x3c!--[if lt IE 9]><link href='" + '../wet-boew/assets/favicon.ico\' rel="shortcut icon" /><link rel="stylesheet" href=\'' +
...
wet.builder.splash = function (a, h) {
    return '\t\t<div id="bg"><img src=\'' + wet.builder.environment(a) + 'img/splash/sp-bg-2.jpg\' alt=""></div><main role="main"><div class="sp-hb"><div class="sp-bx col-xs-12"><h1 property="name" class="wb-inv">Canada.ca</h1><div class="row"><div class="col-xs-11 col-md-8"><object type="image/svg+xml" tabindex="-1" role="img" data=\'' + wet.builder.environment(a) + 'assets/sig-spl.svg\' width="283" aria-label="Government of Canada / Gouvernement du Canada"></object></div></div><div class="row"><section class="col-xs-6 text-right">' +
        ...
        ("external" == a.jqueryEnv ? "https://ajax.googleapis.com/ajax/libs" : "../wet-boew/js/") + 'jquery/2.1.4/jquery.min.js" integrity="sha256-ImQvICV38LovIsvla2zykaCTdEh1Z801Y+DSop91wMU= sha384-8gBf6Y4YYq7Jx97PIqmTwLPin4hxIzQw5aDmUg/DDhul9fFpbbLcLh3nTIIDJKhx sha512-AFwxAkWdvxRd9qhYYp1qbeRZj6/iTNmJ2GFwcxsMOzwwTaRwz2a/2TX225Ebcj3whXte1WGQb38cXE5j7ZQw3g==" crossorigin="anonymous">\x3c/script><script src=\'' + "wet-boew/js/wet-boew.js'>\x3c/script>\x3c!--<![endif]--\x3e\x3c!--[if lt IE 9]><script src='" +
        wet.builder.environment(a) + "js/ie8-wet-boew2.min.js'>\x3c/script><![endif]--\x3e<script src='" + "../wet-boew/js/theme.min.js'>\x3c/script>" + (null != a.webAnalytics ? '<script type="text/javascript">_satellite.pageBottom();\x3c/script>' : "")
};
